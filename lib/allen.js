function allen(maxPremiumCapTable,silverRateTable){
	...
	d3.csv(maxPremiumCapTable,function(error,data){
		console.log("error");
		console.log(error);

		Premiums(silverRateTable);

		console.log("maxPremiumCapTable");
		console.log(data);
   ...
   function Premiums(silverRateTable){
	d3.csv(silverRateTable,function(error,data){
		console.log("error");
		console.log(error);

		console.log("silverRateTable");
		console.log(data);
		...
		function premiumCredit(){
			...
			creditLower = d3.max([0,creditLower]);
			if(userInput.Bracket==1) creditLower = 0;
			...
			var additionalCredit = userInput.premiumCreditLowerFPL - userInput.premiumCredit;
			additionalCredit = d3.max([0,additionalCredit]);
			d3.select("#additionalCredit-value").text(format(Math.floor(additionalCredit)));		
		}
